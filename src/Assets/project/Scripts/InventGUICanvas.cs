...
public class InventGUICanvas : UdonSharpBehaviour
{
    ...
    public GameObject canvas = GameObject.Find("InventoryGUICanvas");
    ...
    public UdonSharpBehaviour itemSlot;
    ...
    private void Update() {
        ...
        if (Input.GetKeyDown(KeyCode.E)) {
            if (itemInHand){
                ...
                itemSlot.SendCustomEvent("SlotInsertion"); // send event to change texture of item slot
            } else {}   
        }
    }
